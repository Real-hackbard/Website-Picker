...
Type TPicker = class
  ...
  public
    ...
    procedure GetFileToLocalFile(URL, FileName : string );
  end;
...
procedure TPicker.GetFileToLocalFile(URL, FileName : string );
var
    Buffer    : Array[1..20480] of ansiChar;
    BufferLen : DWORD;
    FilePath  : File;
    indexF    : Integer;
    t2,TempFileName : string;
begin
    // File name
  ...
  //  Rewrite   ( FilePath, 1 );
  t2:=ExtractFileNameToURL(URL);
  TempFileName:=TempFileName+t2;
